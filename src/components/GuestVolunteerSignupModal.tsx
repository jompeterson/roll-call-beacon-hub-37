...
interface GuestVolunteerSignupModalProps {
  volunteer: Volunteer | null;
  open: boolean;
  onOpenChange: (open: boolean) => void;
}

interface GuestSignupFormData {
  firstName: string;
  lastName: string;
  email: string;
  address: string;
...
export const GuestVolunteerSignupModal = ({ volunteer, open, onOpenChange }: GuestVolunteerSignupModalProps) => {
  ...
  const onSubmit = async (data: GuestSignupFormData) => {
    ...
    try {
      ...
      // Create guest signup record
      const { error } = await supabase
        .from('volunteer_signups')
        .insert({
          volunteer_id: volunteer.id,
          user_id: null, // Guest signup, no user_id
          guest_info: {
