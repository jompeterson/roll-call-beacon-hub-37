...
export const Sidebar = ({ open, onOpenChange }: SidebarProps) => {
  ...
  return (
    <div
      className={cn(
        "fixed top-16 bottom-0 left-0 z-40 w-64 bg-card border-r border-border transform transition-transform duration-300 ease-in-out lg:translate-x-0 lg:static lg:flex lg:flex-col",
